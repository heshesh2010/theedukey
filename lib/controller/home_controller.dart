...
class HomeController extends GetxController {
    ...
    late Rx<Stage> selectedStage=Stage(name: "من فضلك اختر المرحلة التعليمية").obs;
    @override
    void onInit() {
    getStages();
    super.onInit();
  ...
  final RoundedLoadingButtonController btnLoginController = RoundedLoadingButtonController();
  final RoundedLoadingButtonController btnSignUpController = RoundedLoadingButtonController();
  final RoundedLoadingButtonController btnForgetController = RoundedLoadingButtonController();
